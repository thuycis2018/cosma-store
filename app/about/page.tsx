  ...
  return (
    <section>
      ...
      <p className='sm:mt-5 lg:mt-20 text-lg leading-8 max-w-2xl mx-auto text-muted-foreground'>
        ...
        and challenges. We start by conducting thorough consultations to gather
      ...
      <p className='mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground'>
        ...
        established company seeking to optimize your systems, our FPGA design
        expertise is here to support your vision every step of the way.
      </p>
    </section>
  );
}
